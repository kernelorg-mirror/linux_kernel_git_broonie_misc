...
static u64 read_sanitised_id_aa64smfr0_el1(struct kvm_vcpu *vcpu,
					  const struct sys_reg_desc *rd)
{
	u64 val = read_sanitised_ftr_reg(SYS_ID_AA64SMFR0_EL1);
...
static const struct sys_reg_desc sys_reg_descs[] = {
	...
	{ SYS_DESC(SYS_ID_AA64SMFR0_EL1),
	  .access = access_id_reg,
	  .get_user = get_id_reg,
	  .set_user = set_id_reg,
	  .reset = read_sanitised_id_aa64smfr0_el1, },
	ID_UNALLOCATED(4,6),
	ID_UNALLOCATED(4,7),
	...
	{ SYS_DESC(SYS_SVCR), NULL, reset_unknown, SVCR, 0, .visibility = sme_visibility },
